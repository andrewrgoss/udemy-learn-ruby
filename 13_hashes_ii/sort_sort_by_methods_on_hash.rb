...
pokemon = { squirtle: 'Water', bulbasaur: 'Grass', charmander: 'Fire' }
...
p pokemon.sort_by { |pokemon, _type| pokemon } # sorts by keys

p pokemon.sort_by { |pokemon, _type| pokemon }.reverse

p pokemon.sort_by { |_pokemon, type| type } # sorts by values
p pokemon.sort_by { |_pokemon, type| type }.reverse
